...
""" 
author: Zhou Chen
Time: 2022/9/21 20:38
FileName: BNN.py
"""


class Linear_BBB(nn.Module):
    def __init__(self, input_features=14, output_features=14, prior_var=1.):
        """
...
class MLP_BBB(nn.Module):
    def __init__(self, input_features = 14,hidden_units=14*16, noise_tol=.1, prior_var=1.):
        # initialize the network like you would with a standard multilayer perceptron, but using the BBB layer
        super().__init__()
        self.hidden = Linear_BBB(input_features, hidden_units, prior_var=prior_var)
        self.out = Linear_BBB(hidden_units, input_features, prior_var=prior_var)
